...
#        self.throttle1.setSpeedSetting(0.9)
        ...
        print "Set speed to 1"
        self.throttle2.setSpeedSetting(0.1)
        self.waitMsec(2500)
        print "Set speed to 2"
        self.throttle2.setSpeedSetting(0.2)
        self.waitMsec(2000)
        print "Set speed to 3"
        self.throttle2.setSpeedSetting(0.3)
#        self.waitMsec(1500)
#        print "Set speed to 4"
#        self.throttle2.setSpeedSetting(0.4)
#        self.waitMsec(1000)
#        print "Set speed to 5"
#        self.throttle2.setSpeedSetting(0.5)
#        self.waitMsec(1000)
#        print "Set speed to 6"
#        self.throttle2.setSpeedSetting(0.6)
#        self.waitMsec(750)
#        print "Set speed to 7"
#        self.throttle2.setSpeedSetting(0.7)
#        self.waitMsec(500)  
#        print "Set speed to 8"
#        self.throttle2.setSpeedSetting(0.8)
#        self.waitMsec(500)
#        print "Set speed to 9"
#        self.throttle2.setSpeedSetting(0.9)
        print "Outer loop loco leaving yard"
        self.waitMsec(2500)
